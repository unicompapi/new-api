...
const (
	...
	MsgUserSMSTooFrequent            = "user.sms_too_frequent"
	MsgUserSMSSendFailed             = "user.sms_send_failed"
	MsgUserHumanVerificationFailed   = "user.human_verification_failed"
	MsgUserPhoneOrCodeError          = "user.phone_or_code_error"
