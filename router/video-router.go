...
func SetVideoRouter(router *gin.Engine) {
	...
	// Kling v3 native API routes (kling-3.0-turbo, etc.)
	// Accept the official Kling v3 request format directly.
	klingV3Router := router.Group("/kling")
	...
	{
		klingV3Router.POST("/text-to-video/:model_id", controller.RelayTask)
		klingV3Router.POST("/image-to-video/:model_id", controller.RelayTask)
		klingV3Router.GET("/tasks", controller.RelayTaskFetch)
	}
